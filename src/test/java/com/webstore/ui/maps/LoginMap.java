...
public class LoginMap {
    ...
    public By genderRadioButton() {
        return By.cssSelector("#id_gender1");
    }
    ...
    public By mobilePhoneField() {
        return By.cssSelector("#phone_mobile");
    }

    public By submitAccountButton() {
